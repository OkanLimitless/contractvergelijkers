 ...
 * Generates Tailwind classes based on brand colors from content
 */
...
/**
 * Gets color scheme based on brand color
 * @param brandColor - The brand color from content
 * @returns ColorScheme object with Tailwind classes
 */
export function getColorScheme(brandColor: string = 'blue'): ColorScheme {
  const normalizedColor = (brandColor.toLowerCase() as BrandColor) || 'blue'
  return colorSchemes[normalizedColor] || colorSchemes.blue
}

/**
 * Gets hero gradient classes
 * @param brandColor - The brand color from content
 * @returns Tailwind gradient classes
 */
export function getHeroGradient(brandColor: string = 'blue'): string {
  return getColorScheme(brandColor).gradient
}
 ...
 */
export function getButtonClasses(brandColor: string = 'blue'): string {
  const scheme = getColorScheme(brandColor)
  return `${scheme.buttonBg} ${scheme.buttonText} ${scheme.buttonHover}`
}
